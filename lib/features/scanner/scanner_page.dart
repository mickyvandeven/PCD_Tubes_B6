        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              border: Border.all(
                  color: const Color(0xFF44F0D2).withOpacity(0.25), width: 2),
            ),
          ),
          // Middle ring
          Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              border: Border.all(
                  color: const Color(0xFF44F0D2).withOpacity(0.4), width: 2),
  ...
  List<Widget> _buildCorners() {
    return [
      Positioned(
        top: 22,
        left: 22,
        child: _CornerDeco(topLeft: true),
      ),
      Positioned(
        top: 22,
        right: 22,
        child: _CornerDeco(topRight: true),
      ),
      Positioned(
        bottom: 22,
        left: 22,
        child: _CornerDeco(bottomLeft: true),
      ),
      Positioned(
        bottom: 22,
        right: 22,
        child: _CornerDeco(bottomRight: true),
      ),
    ];
  }
}
            ...
            child: Column(
              ...
              children: [
                const Icon(Icons.error_outline_rounded,
                    color: Color(0xFFFF5C6B), size: 60),
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: const Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(Icons.auto_awesome, color: Color(0xFF0D1020), size: 12),
                    SizedBox(width: 4),
                    Text(
                      'AI Analyzed',
                      style: TextStyle(
          ...
          Row(
            children: [
              Container(
                ...
                child:
                    Icon(Icons.restaurant_rounded, color: _fatColor, size: 18),
              ),
              const SizedBox(width: 10),
              Expanded(
                child: Column(
              ...
              _GramButton(
                ...
                onTap: () {
                  ...
                  context
                      ...
                      .updateGram(widget.foodIndex, newVal);
                },
              ),
              const SizedBox(width: 8),
              // Input field
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(
                          color: _fatColor.withOpacity(0.6), width: 1.5),
                    ),
                    suffix: const Text(
                      'g',
